...
var TwistMaterial = function TwistMaterial() {
	...
	this.init = function( world ) {
		...
		this._materialNode = createMaterialNode("twistMaterial" + "_" + world.generateUniqueNodeID());
...
var twistMaterialDef =
{'shaders': 
	{
		'defaultVShader':"assets/shaders/Basic.vert.glsl",
		'defaultFShader':"assets/shaders/Twist.frag.glsl"
	},
	'techniques':
	{ 
		'default':
...
TwistMaterial.prototype = new PulseMaterial();

if (typeof exports === "object") {
    exports.TwistMaterial = TwistMaterial;
}
