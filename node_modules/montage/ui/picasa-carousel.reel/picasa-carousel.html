...
<head>
    ...
    {
        "owner": {
            "prototype": "montage/ui/picasa-carousel.reel",
            "properties": {
            ...
            "image1": {
                "prototype": "montage/ui/picasa-carousel.reel/image.reel",
                "properties": {
                    "element": {"#": "image"}
                },
                "bindings": {
            ...
            "path2": {
                ...
                "properties": {
                    "evalPath": [
                        ...
                        "path.translateY = 0",
                        "path.translateZ = Math.pow(1.1, -slide.time*slide.time/30000)*600-600",
                        "path.rotateX = 0",
                        "path.rotateY = 0",
...
<body>
    ...
    <div data-montage-id="montage-google-picasa-carousel" class="montage-google-picasa-carousel">
    	<div id="flow" class="flow" style="-webkit-perspective: 1400px; -webkit-transform-style: preserve-3d; width:800px; height:160px; border:1px;">
